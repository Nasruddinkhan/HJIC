...
import com.jsoft.hjic.model.Cheque;
import com.jsoft.hjic.model.DetailInsert;
...
table5.setSpacingBefore(5);
		...
		phrase.add(new Chunk(
				" أعضاء البيانات سبيل المثال سو�? تحصل على الذاكرة �?ي كل مرة عندما يتم إنشاء الكائن.كل طالب لها رولنو �?ريدة واسم حتى عضو البيانات مثيل هولن�?ترض أن هناك 500 طالب �?ي كليتي، والآن جميع أعضاء البيانات سبيل المثال سو�? تحصل على الذاكرة �?ي كل مرة عندما يتم إنشاء الكائن.كل طالب لها رولنو �?ريدة واسم حتى عضو البيانات مثيل ،  الكائنات . إذا جعلنا ثابت، هذا الحقل سو�? تحصل على الذاكرة مرة واحدة �?قط.",
				fontArabic8));
		ppcell.addElement(phrase);
		ppcell.setRunDirection(PdfWriter.RUN_DIRECTION_RTL);
		ppcell.setBorderWidth(0f);
