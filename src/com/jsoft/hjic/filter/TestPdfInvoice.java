...
public class TestPdfInvoice {
 ...
 public static void main(String[] args) {
  ...
  String pdfFilename = "";
  TestPdfInvoice generateInvoice = new TestPdfInvoice();
  pdfFilename = "D://Application//payment_invoice.pdf";
 ...
 private void generateLayout(Document doc, PdfContentByte cb)  {
  ...
  try {
   ...
   createHeadings(cb,422,743,"Student Id.");
   createHeadings(cb,422,723,"Student Name.");
   createHeadings(cb,422,703,"Payment Date");
   ...
   createHeadings(cb,52,633,"Month");
   createHeadings(cb,152,633,"Payment description");
   createHeadings(cb,432,633,"Payment amount");
   createHeadings(cb,502,633,"other amt");
 ...
 private void generateHeader(Document doc, PdfContentByte cb)  {
  ...
  try {
   ...
   createHeadings(cb,200,750,"School Name");
   ...
   createHeadings(cb,482,743,"ABCDEFG");
   createHeadings(cb,482,723,"123456");
   createHeadings(cb,482,703,"26-MAR-18");
 ...
 private void generateDetail(Document doc, PdfContentByte cb, int index, int y)  {
	 ...
	 try {
		 ...
		 createContent(cb,52,y, "JAN" + String.valueOf(index+1),PdfContentByte.ALIGN_LEFT);
		 createContent(cb,152,y, "Payment remarks" + String.valueOf(index+1),PdfContentByte.ALIGN_LEFT);

		 double price = Double.valueOf(df.format(Math.random() * 1000));
	 ...
	 System.out.println("TestPdfInvoice.generateDetail() done");
 }
